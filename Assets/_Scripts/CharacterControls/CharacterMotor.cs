...
public class CharacterMotor : MonoBehaviour
{
	...
	public CharacterMotorMovement walkMovement = new CharacterMotorMovement();
	public CharacterMotorMovement runMovement = new CharacterMotorMovement();
    [HideInInspector]
    ...
    void Awake()
    {
        ...
        tr = transform;
		movement = walkMovement; //by default
    }

    private void UpdateFunction()
    {
		if(Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)) movement = runMovement;
		else movement = walkMovement;
